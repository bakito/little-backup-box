...
# Icon
draw.text((x, top+12), unichr(61452),  font=fa_solid_40, fill=255)

# Text
draw.text((47, top+15),    "Backup",  font=font_text, fill=255)
draw.text((47, top+30),    "complete",  font=font_text, fill=255)
